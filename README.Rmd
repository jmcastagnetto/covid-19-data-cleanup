...
*Notes*
  ...
  - **2020-03-12**: source data no longe has the classification "Others" for locations not corresponding to countries (i.e. Cruise Ships), so the code has been modified to account for that change.
